...
\subsection{Python ROS entity extraction}
...
\subsection{Launch and deployment extraction}
...
\subsection{Parameter-file extraction}
...
\subsection{Package metadata and repository boundary}
...
\subsection{Deployment instances}
...
\subsection{Effective configuration and provenance}
...
\subsection{Effective interfaces and system relationships}
...
\subsection{Resolution status and unresolved facts}
...
\subsection{Physical configuration representation}
...
\subsection{Frozen model and freshness}
...
\subsection{Grounded parameter evidence}
...
\subsection{Optional semantic enrichment}
...
\subsection{Stable instructions and request-specific context}
...
\subsection{Deterministic capability realization}
...
\subsection{ROS orchestration verification}
...
\subsection{Complete parameter catalogue}
...
\subsection{Bounded context construction}
...
\subsection{Language-model parameter selection}
...
\subsection{Separate value reasoning}
...
\section{Configuration Plan Generation}
...
\subsection{Artifact and registry validation}
...
\subsection{Interpretation and selection validation}
...
\subsection{Plan and rendering validation}
...
\subsection{Capability interpretation and realization}
...
\subsection{Retrieval and parameter selection}
...
\subsection{Value reasoning and plan generation}
