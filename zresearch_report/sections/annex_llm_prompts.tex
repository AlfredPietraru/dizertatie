...
The responses are raw JSON from \texttt{qwen2.5-coder:7b} for case \texttt{seed-108-p01}. Machine-generated catalogue and schema sections are abbreviated.
...
The second call selects identifiers from parameters in the approved component scope; it does not calculate values.
...
The final call derives values only for the validated selection.
